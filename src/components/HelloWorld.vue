    ...
    <div>
      <a-page-header style="border: 1px solid rgb(235, 237, 240)" title="Title" sub-title="This is a subtitle"
        ...
        <a-descriptions size="small" :column="3">
          ...
          <a-descriptions-item label="test"> 2017-10-10 </a-descriptions-item>
      ...
      <a-page-header title="Title" sub-title="This is a subtitle" @back="() => $router.go(-1)">
        ...
        <a-input-number :formatter="
          ...
          " :parser="(value) => value.replace(/\$\s?|(,*)/g, '')" id="inputNumber" v-model="num" :min="1" :max="10" />
        <a-input v-model="num" />
        <a-row type="flex">
          <a-statistic title="Status" value="Pending" />
          <a-statistic title="Price" prefix="$" :value="568.08" :style="{
              margin: '0 32px',
            }" />
